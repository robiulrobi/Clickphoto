	...
	<section class="gallery-section">
		<div class="row gallery-gird">
			<div class="col-lg-4 col-xl-3 col-sm-6">
				<a class="gallery-item fresco" href="{{asset('/')}}/frontEnd/img/projects/1.jpg" data-fresco-group="projects">
					<img src="{{asset('/')}}/frontEnd/img/projects/1.jpg" alt="">
					<div class="gi-text">
			...
			<div class="col-lg-4 col-xl-3 col-sm-6">
				<a class="gallery-item fresco" href="{{asset('/')}}/frontEnd/img/projects/2.jpg" data-fresco-group="projects">
					<img src="{{asset('/')}}/frontEnd/img/projects/2.jpg" alt="">
					<div class="gi-text">
						<h4>Forest and Nature</h4>
						<p>Natures / Tree</p>
					</div>
			...
			<div class="col-lg-4 col-xl-3 col-sm-6">
				<a class="gallery-item fresco" href="{{asset('/')}}/frontEnd/img/projects/3.jpg" data-fresco-group="projects">
					<img src="{{asset('/')}}/frontEnd/img/projects/3.jpg" alt="">
					<div class="gi-text">
						<h4>Forest and Nature</h4>
						<p>Natures / Tree</p>
					</div>
			...
			<div class="col-lg-4 col-xl-3 col-sm-6">
				<a class="gallery-item fresco" href="{{asset('/')}}/frontEnd/img/projects/4.jpg" data-fresco-group="projects">
					<img src="{{asset('/')}}/frontEnd/img/projects/4.jpg" alt="">
					<div class="gi-text">
						<h4>Forest and Nature</h4>
						<p>Natures / Tree</p>
					</div>
